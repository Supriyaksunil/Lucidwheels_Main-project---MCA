...
class Firestore extends JsObjectWrapper<firestore_interop.FirestoreJsImpl> {
  ...
  Firestore._fromJsObject(super.jsObject)
      : super.fromJsObject();
  ...
  Future runTransaction(
    ...
    JSPromise<JSAny?> updateFunctionWrap(firestore_interop.TransactionJsImpl transaction) {
...
class LoadBundleTask
  ...
  LoadBundleTask._fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class WriteBatch extends JsObjectWrapper<firestore_interop.WriteBatchJsImpl> {
  ...
  WriteBatch._fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class DocumentChange
  ...
  DocumentChange._fromJsObject(super.jsObject)
      : super.fromJsObject();
}
...
class QuerySnapshot
  ...
  QuerySnapshot._fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class Transaction extends JsObjectWrapper<firestore_interop.TransactionJsImpl> {
  ...
  Transaction._fromJsObject(super.jsObject)
      : super.fromJsObject();
