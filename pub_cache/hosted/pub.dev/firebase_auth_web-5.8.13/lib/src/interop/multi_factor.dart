...
class MultiFactorUser
  ...
  MultiFactorUser._fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class MultiFactorSession
  ...
  MultiFactorSession.fromJsObject(super.jsObject)
      : super.fromJsObject();
}
...
class MultiFactorResolver
  ...
  MultiFactorResolver.fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class TotpSecret extends JsObjectWrapper<auth_interop.TotpSecretJsImpl> {
  TotpSecret.fromJsObject(super.jsObject)
      : super.fromJsObject();
