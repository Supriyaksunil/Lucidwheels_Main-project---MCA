...
class IdTokenResult extends JsObjectWrapper<auth_interop.IdTokenResultImpl> {
  IdTokenResult._fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class Auth extends JsObjectWrapper<auth_interop.AuthJsImpl> {
  ...
  Auth._fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class EmailAuthProvider
  ...
  EmailAuthProvider.fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class OAuthProvider extends AuthProvider<auth_interop.OAuthProviderJsImpl> {
  ...
  OAuthProvider.fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class SAMLAuthProvider
  ...
  SAMLAuthProvider.fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class PhoneAuthProvider
  ...
  PhoneAuthProvider.fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class RecaptchaVerifier
  ...
  RecaptchaVerifier.fromJsObject(super.jsObject)
      : super.fromJsObject();
...
class UserCredential
  ...
  UserCredential.fromJsObject(super.jsObject)
      : super.fromJsObject();
}
